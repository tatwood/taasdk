/**
 * @brief     keyboard input implementation for android
...
static uint8_t* taa_keyboard_init(Display* d)
{
    ...
    taa_keyboard_mapkey(map,AKEYCODE_TAB          ,taa_KEY_TAB);
    taa_keyboard_mapkey(map,AKEYCODE_ENTER        ,taa_KEY_ENTER);
    ...
    taa_keyboard_mapkey(map,AKEYCODE_SPACE        ,taa_KEY_SPACE);
    taa_keyboard_mapkey(map,AKEYCODE_PAGE_UP      ,taa_KEY_PAGE_UP);
    taa_keyboard_mapkey(map,AKEYCODE_PAGE_DOWB    ,taa_KEY_PAGE_DOWN);
    ...
    taa_keyboard_mapkey(map,AKEYCODE_DEL          ,taa_KEY_DELETE);
    taa_keyboard_mapkey(map,AKEYCODE_0            ,taa_KEY_0);
    taa_keyboard_mapkey(map,AKEYCODE_1            ,taa_KEY_1);
    taa_keyboard_mapkey(map,AKEYCODE_2            ,taa_KEY_2);
    taa_keyboard_mapkey(map,AKEYCODE_3            ,taa_KEY_3);
    taa_keyboard_mapkey(map,AKEYCODE_4            ,taa_KEY_4);
    taa_keyboard_mapkey(map,AKEYCODE_5            ,taa_KEY_5);
    taa_keyboard_mapkey(map,AKEYCODE_6            ,taa_KEY_6);
    taa_keyboard_mapkey(map,AKEYCODE_7            ,taa_KEY_7);
    taa_keyboard_mapkey(map,AKEYCODE_8            ,taa_KEY_8);
    taa_keyboard_mapkey(map,AKEYCODE_9            ,taa_KEY_9);
    taa_keyboard_mapkey(map,AKEYCODE_A            ,taa_KEY_A);
    taa_keyboard_mapkey(map,AKEYCODE_B            ,taa_KEY_B);
    taa_keyboard_mapkey(map,AKEYCODE_C            ,taa_KEY_C);
    taa_keyboard_mapkey(map,AKEYCODE_D            ,taa_KEY_D);
    taa_keyboard_mapkey(map,AKEYCODE_E            ,taa_KEY_E);
    taa_keyboard_mapkey(map,AKEYCODE_F            ,taa_KEY_F);
    taa_keyboard_mapkey(map,AKEYCODE_G            ,taa_KEY_G);
    taa_keyboard_mapkey(map,AKEYCODE_H            ,taa_KEY_H);
    taa_keyboard_mapkey(map,AKEYCODE_I            ,taa_KEY_I);
    taa_keyboard_mapkey(map,AKEYCODE_J            ,taa_KEY_J);
    taa_keyboard_mapkey(map,AKEYCODE_K            ,taa_KEY_K);
    taa_keyboard_mapkey(map,AKEYCODE_L            ,taa_KEY_L);
    taa_keyboard_mapkey(map,AKEYCODE_M            ,taa_KEY_M);
    taa_keyboard_mapkey(map,AKEYCODE_N            ,taa_KEY_N);
    taa_keyboard_mapkey(map,AKEYCODE_O            ,taa_KEY_O);
    taa_keyboard_mapkey(map,AKEYCODE_P            ,taa_KEY_P);
    taa_keyboard_mapkey(map,AKEYCODE_Q            ,taa_KEY_Q);
    taa_keyboard_mapkey(map,AKEYCODE_R            ,taa_KEY_R);
    taa_keyboard_mapkey(map,AKEYCODE_S            ,taa_KEY_S);
    taa_keyboard_mapkey(map,AKEYCODE_T            ,taa_KEY_T);
    taa_keyboard_mapkey(map,AKEYCODE_U            ,taa_KEY_U);
    taa_keyboard_mapkey(map,AKEYCODE_V            ,taa_KEY_V);
    taa_keyboard_mapkey(map,AKEYCODE_W            ,taa_KEY_W);
    taa_keyboard_mapkey(map,AKEYCODE_X            ,taa_KEY_X);
    taa_keyboard_mapkey(map,AKEYCODE_Y            ,taa_KEY_Y);
    taa_keyboard_mapkey(map,AKEYCODE_Z            ,taa_KEY_Z);
    ...
    taa_keyboard_mapkey(map,AKEYCODE_SHIFT_LEFT   ,taa_KEY_LSHIFT);
    taa_keyboard_mapkey(map,AKEYCODE_SHIFT_RIGHT  ,taa_KEY_RSHIFT);
    taa_keyboard_mapkey(map,d,XK_Control_L        ,taa_KEY_LCTRL);
    taa_keyboard_mapkey(map,d,XK_Control_R        ,taa_KEY_RCTRL);
    taa_keyboard_mapkey(map,AKEYCODE_ALT_LEFT     ,taa_KEY_LALT);
    taa_keyboard_mapkey(map,AKEYCODE_ALT_RIGHT    ,taa_KEY_RALT);
    taa_keyboard_mapkey(map,AKEYCODE_SEMICOLON    ,taa_KEY_SEMICOLON);
    taa_keyboard_mapkey(map,AKEYCODE_EQUALS       ,taa_KEY_EQUAL);
    taa_keyboard_mapkey(map,AKEYCODE_COMMA        ,taa_KEY_COMMA);
    taa_keyboard_mapkey(map,AKEYCODE_MINUS        ,taa_KEY_MINUS);
    taa_keyboard_mapkey(map,AKEYCODE_PERIOD       ,taa_KEY_PERIOD);
    taa_keyboard_mapkey(map,AKEYCODE_SLASH        ,taa_KEY_SLASH);
    taa_keyboard_mapkey(map,AKEYCODE_GRAVE        ,taa_KEY_BACKQUOTE);
    taa_keyboard_mapkey(map,AKEYCODE_LEFT_BRACKET ,taa_KEY_LEFTBRACKET);
    taa_keyboard_mapkey(map,AKEYCODE_BACKSLASH    ,taa_KEY_BACKSLASH);
    taa_keyboard_mapkey(map,AKEYCODE_RIGHT_BRACKET,taa_KEY_RIGHTBRACKET);
    taa_keyboard_mapkey(map,AKEYCODE_APOSTROPHE   ,taa_KEY_QUOTE);
    return map;
}
